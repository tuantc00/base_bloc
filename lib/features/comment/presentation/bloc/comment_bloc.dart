...
typedef Emit = Emitter<GenericBlocState<CommentEntity>>;

class CommentBloc extends Bloc<CommentEvent, GenericBlocState<CommentEntity>>
    with BlocHelper<CommentEntity> {
  CommentBloc({
